 ...
 * @since 1.0.0
 */
if (!class_exists('Docile_Post_Grid')) :
     ...
     * @since 1.0.0
     */
    class Docile_Post_Grid extends WP_Widget
    {

         private function defaults()
        {
            $defaults = array(
            'title' => esc_html__('Grid Posts', 'docile' ),
            'cat' => 0,
            'post-number' => 6,
            'excerpt-length'=> 15,
           );
        ...
        {
            $opts = array(
                'classname' => 'docile-post-grid',
                'description' => esc_html__('Display post in Grid Form. Suitable on Sidebars.', 'docile'),
            );

            parent::__construct('docile-post-grid', esc_html__('Docile Post Grid', 'docile'), $opts);
        }
