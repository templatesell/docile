 ...
 * @since 1.0.0
 */
if (!class_exists('Docile_Featured_Post_Slider')) :
     ...
     * @since 1.0.0
     */
    class Docile_Featured_Post_Slider extends WP_Widget
    {

         private function defaults()
        {
            $defaults = array(
            'title' => esc_html__('Featured Posts Slider', 'docile' ),
            'cat' => 0,
            'post-number' => 5,
            'excerpt-length'=> 15,
           );
        ...
        {
            $opts = array(
                'classname' => 'docile-featured-post-slider',
                'description' => esc_html__('Display post in Grid Form. Suitable on Sidebars.', 'docile'),
            );

            parent::__construct('docile-featured-post-slider', esc_html__('Docile Featured Post Slider', 'docile'), $opts);
        }
