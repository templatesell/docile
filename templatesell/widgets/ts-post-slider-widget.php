 ...
 * @since 1.0.0
 */
if (!class_exists('Docile_Post_Slider')) :
     ...
     * @since 1.0.0
     */
    class Docile_Post_Slider extends WP_Widget
    {

         private function defaults()
        {
            $defaults = array(
            'title' => esc_html__('Slide Posts', 'docile' ),
            'cat' => 0,
            'post-number' => 5,
           );
        return $defaults;
        ...
        {
            $opts = array(
                'classname' => 'docile-post-slider',
                'description' => esc_html__('Display post in Slider Form. Suitable on Sidebars.', 'docile'),
            );

            parent::__construct('docile-post-slider', esc_html__('Docile Post Slider', 'docile'), $opts);
        }
