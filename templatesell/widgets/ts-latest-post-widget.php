 ...
 * @since 1.0.0
 */
if (!class_exists('Docile_Latest_Post')) :
     ...
     * @since 1.0.0
     */
    class Docile_Latest_Post extends WP_Widget
    {

     private function defaults()
     {
      $defaults = array(
        'title' => esc_html__('Latest Posts', 'docile' ),
        'cat' => 0,
        'post-number' => 5,
      );
      return $defaults;
    ...
    {
      $opts = array(
        'classname' => 'docile-latest-post',
        'description' => esc_html__('Display lastest post and from category.', 'docile'),
      );

      parent::__construct('docile-latest-post', esc_html__('Docile Latest Posts', 'docile'), $opts);
    }
