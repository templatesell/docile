 ...
 *
 */
if (!function_exists('docile_list_category')) :
    function docile_list_category($post_id = 0)
    {
...
if (!function_exists('docile_add_menu_description')) :
...
add_filter( 'walker_nav_menu_start_el', 'docile_add_menu_description', 10, 4 );