...
require get_template_directory() . '/templatesell/widgets/ts-post-slider-widget.php';
require get_template_directory() . '/templatesell/widgets/ts-tabbed-widget.php';
require get_template_directory() . '/templatesell/widgets/ts-post-grid-widget.php';
require get_template_directory() . '/templatesell/widgets/ts-featured-post-widget.php';
require get_template_directory() . '/templatesell/widgets/ts-featured-post-slider-widget.php';
require get_template_directory() . '/templatesell/widgets/ts-post-column-widget.php';
require get_template_directory() . '/templatesell/widgets/ts-latest-post-widget.php';
...
require get_template_directory() . '/templatesell/hooks/front-page.php';
