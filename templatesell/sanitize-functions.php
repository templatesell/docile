 ...
 */
function docile_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function docile_sanitize_select( $input, $setting ) {
 ...
 *                    the setting default.
 */
function docile_sanitize_number_range( $number, $setting ) {
 ...
 *  @since Springy 1.0.0
 */
if (!function_exists('docile_sanitize_number')) :
    function docile_sanitize_number($input)
    {
 ...
 *
 */
if ( !function_exists('docile_sanitize_image') ) :
	function docile_sanitize_image( $image, $setting ) {
		/*
