      ...
      <div class="col-lg-3 col-md-5 col-sm-12">
        <div class="tab__wrapper">
          <ul id="tab_first" class="tabs-nav">
            ...
            <li class="current" data-tab="TB2"><button><i class="fa fa-clock-o"></i><?php esc_html_e('Recent', 'docile'); ?></button></li>

              <li data-tab="TB1"><button><i class="fa fa-fire"></i><?php esc_html_e('Popular', 'docile'); ?></a></li>
              
              <li data-tab="TB3"><button><i class="fa fa-random"></i><?php esc_html_e('Trending', 'docile'); ?></button></li>
          </ul>
